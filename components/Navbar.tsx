...
const Navbar = () => {
  ...
  const linkItems = [
    ...
    { path: "/properties/add", name: "Add Property" },
  ];
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="hidden md:ml-6 md:block">
              <div className="flex space-x-2">
                {linkItems.map((link) => {
                  if (!session && link.name === "Add Property") {
                    return null;
                  }
                  return (
                    <Link
            ...
            {linkItems.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`${
                    pathname === link.path ? "bg-black" : ""
                  } text-white text-white block rounded-md px-3 py-2 text-base font-medium`}
                >
                  {link.name}
                </Link>
              );
